...
/** A Pyrotech shovel: vanilla's, with the durability tooltip and an optional active behaviour. */
public class PyrotechShovelItem extends ShovelItem implements ActiveTool {

    @Nullable
    private final ActiveBehaviour active;

    public PyrotechShovelItem(Tier tier, @Nullable ActiveBehaviour active, Properties properties) {
