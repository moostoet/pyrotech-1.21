...
/** A Pyrotech pickaxe: vanilla's, with the durability tooltip and an optional active behaviour. */
public class PyrotechPickaxeItem extends PickaxeItem implements ActiveTool {

    @Nullable
    private final ActiveBehaviour active;

    public PyrotechPickaxeItem(Tier tier, @Nullable ActiveBehaviour active, Properties properties) {
